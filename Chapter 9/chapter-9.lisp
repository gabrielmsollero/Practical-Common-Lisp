...
(defmacro check (&body forms)
  ...
  `(combine-results
    ...
    ,@(loop for f in forms collect `(report-result ,f ',f)))) ; ,f avalia f (variável) e retorna a forma, avaliando-a. ',f retorna a mesma forma mas impede que seja avaliada.
